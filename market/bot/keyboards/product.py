...
def get_product_keyboard(slug: str, product_id: int):
    ...
    keyboard.button(text="🔄 Выбрать другой вкус", callback_data=f"catalog:category:{slug}")
    keyboard.button(text="🔙 Вернуться к выбору категорий", callback_data="menu:catalog")
