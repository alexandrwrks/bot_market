...
def get_back_admin_keyboard():
    ...
    keyboard.button(
        text="🔙 Вернуться в главное меню", callback_data="admin_panel:menu"
    )
...
def access_product_delete(slug: str, product_id: int):
    ...
    keyboard.button(
        ...
        callback_data=f"admin_panel:product:delete:{slug}:{product_id}:cancel",
    )
    keyboard.button(
        text="✅ Подтвердить удаление",
        callback_data=f"admin_panel:product:delete:{slug}:{product_id}:confirm",
    )
...
def get_access_add_product():
    ...
    keyboard.button(
        text="❌ Отменить", callback_data="admin_panel:products:add_confirmation:cancel"
    )
    keyboard.button(
        text="✅ Добавить",
        callback_data="admin_panel:products:add_confirmation:confirm",
    )
...
def get_categories_keyboard(categories: List[Category]):
    ...
    keyboard.button(
        text="➕ Добавить категорию", callback_data="admin_panel:category:add"
    )
...
def access_add_new_category():
    ...
    keyboard.button(
        text="✅ Добавить", callback_data="admin_panel:category_add:confirm"
    )
